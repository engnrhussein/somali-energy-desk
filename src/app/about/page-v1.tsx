      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-16 md:gap-24">
          ...
          <div className="flex flex-col">
            <div className="mb-8">
              <h1 className="font-sans font-medium text-2xl tracking-tight text-onyx mb-2">
                Chemical Engineer <span className="text-slate-dim">&amp;</span> SED Founder
              </h1>
              <p className="font-mono text-xs text-safety uppercase tracking-widest font-bold">
                Lead Author &amp; Analyst
              </p>
            </div>
          ...
          <div className="flex flex-col justify-start">
            ...
            <div className="mb-14">
              <h2 className="font-mono text-xs text-safety font-bold tracking-widest uppercase mb-4">
